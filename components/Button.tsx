...
const baseStyles = {
  solid:
    'inline-flex justify-center items-center rounded-lg py-2 px-3 text-sm font-semibold transition-colors',
  outline:
...
const variantStyles = {
  solid: {
    ...
    green: 'bg-[#59a946] text-white hover:bg-green-600 active:bg-green-500 active:text-white/80',
  },
  outline: {
